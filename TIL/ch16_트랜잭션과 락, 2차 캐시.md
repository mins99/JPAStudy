...
https://nesoy.github.io/articles/2019-05/Database-Transaction-isolation 그림 참고
...
+ 캐시 모드는 em.setProperty()로 엔티티 매니저 단위로 설정하거나 em.find(), em.refresh()에 설정할 수 있다. Query.setHint()에 사용할 수 있다
``` java
